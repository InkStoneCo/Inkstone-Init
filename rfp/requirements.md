...
Vibe Coder 技術能力限制，讓他儘量簡單達成。
1. 下載插件即可，因為終端機對他可能更難，但可保留「/vibe-coding」，這功能不難他能理解。
2. 方便寫筆記：原本記憶會寫入 Claude Flow 的 Sqlite，讀取資料庫對他比較難，他可以用 Code-Mind 功能在一個專案維護一個全域的 md 檔，查看較容易
3. 原本 Code-mind 的筆記撰寫還有點難度，看是否能更簡單，因為安裝插件，在檔案任何地方按右鍵就能插入筆記？
4. Claude-Code 的恢復記憶、存入記憶、SPARC、SWARM 等基本需求也寫入用按鈕就能執行
