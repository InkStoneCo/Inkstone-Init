...
import { initCommand, daemonCommand, mapCommand, listCommand, showCommand, treeCommand, addCommand, editCommand, deleteCommand, linkCommand, unlinkCommand, searchCommand, refsCommand, orphansCommand, popularCommand, expandCommand, scanCommand, checkCommand, exportCommand, statsCommand, } from './commands/index.js';
program
    .name('codemind')
